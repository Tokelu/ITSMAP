...
//    private int ADAPTER_POSITION_FROM_RECYCLE_VIEW;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            clickedJob = (Job) savedInstanceState.getParcelable(getString(R.string.jobSaved));
        }
        initializeIU();
...
//        });
    ...
    public void btnClickedSave(View view){
        if (isBound){
            clickedJob.setIsMarkedApplied(appliedCheckBox.isChecked());
            clickedJob.setNotes(notes.getText().toString());
            clickedJob.setCoolnessScore(coolScore.getText().toString());
            jobService.updateJob(clickedJob);
        }
    ...
    private void updateIU(Job job)
    {
        ...
        if (job.getIsMarkedApplied())        { appliedCheckBox.setChecked(true); }
    ...
    public void onSaveInstanceState(Bundle savedInstanceState)
    {
        ...
        clickedJob.setNotes(notes.getText().toString());
        clickedJob.setIsMarkedApplied(appliedCheckBox.isChecked());
        savedInstanceState.putParcelable(getString(R.string.jobSaved), clickedJob);
    }
}
